      ...
      {!! Form::open(['route' => ['items.store'], 'files' => true, ]) !!}
        <div class="modal-content">
            ...
            <div class="modal-body">
              ...
              <!-- item_item_id Form Input -->
              <div class="form-group @if ($errors->has('item_item_id')) has-error @endif">
              ...
              <div class="form-group @if ($errors->has('active')) has-error @endif">
                  ...
                  {!! Form::select('active',['0','1'], old('$item->active'), ['class' => 'form-control', 'placeholder' => 'active']) !!}
                  @if ($errors->has('active')) <p class="help-block">{{ $errors->first('active') }}</p> @endif
              </div>
              <!-- Permissions -->
              @if(isset($user))
                  @include('shared._permissions', ['closed' => 'true', 'model' => $package ])
              @endif
            </div>
