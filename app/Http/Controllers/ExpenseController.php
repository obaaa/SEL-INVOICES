...
class ExpenseController extends Controller
{
    ...
    {
      $expense_categories = Expense_categorie::where('id', '!=', 1)->get()->pluck('name','id')->prepend('Please Select', '');
      $result = Expense::latest()->paginate();
      return view('expense.index', compact('result', 'expense_categories'));
    }
